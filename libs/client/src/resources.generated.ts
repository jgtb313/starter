...
export const InvoiceSchema = z.union([
  z.object({
    invoiceId: z.string().uuid().describe('Unique identifier for invoice'),
    ...
    card: z.object({
      token: z.string().describe('Token representing a securely stored payment card, typically returned by a payment provider.'),
      number: z.string().describe('Masked card number for secure display.'),
      holderName: z.string().describe('Name of the cardholder as printed on the card.'),
      expirationDate: z.string().describe('Card expiration date in MM/YY format.'),
    }),
    dueDate: z.iso.datetime().transform((value) => new Date(value)),
    issuedAt: z.iso.datetime().transform((value) => new Date(value)),
    paidAt: z.union([z.iso.datetime().transform((value) => new Date(value)), z.null()]),
    canceledAt: z.union([z.iso.datetime().transform((value) => new Date(value)), z.null()]),
  ...
  z.object({
    ...
    pix: z.object({
      qrCodeUrl: z.string().url().describe('Direct URL to the Pix QR Code, returned by the payment provider.'),
      expiresAt: z.iso
        .datetime()
        .transform((value) => new Date(value))
        .describe('Expiration date and time for the Pix payment in ISO format.'),
    }),
    dueDate: z.iso.datetime().transform((value) => new Date(value)),
    issuedAt: z.iso.datetime().transform((value) => new Date(value)),
    paidAt: z.union([z.iso.datetime().transform((value) => new Date(value)), z.null()]),
  ...
  z.object({
    ...
    boleto: z.object({
      ...
      expiresAt: z.iso
        .datetime()
        .transform((value) => new Date(value))
        .describe('Expiration date and time for the Boleto payment in ISO format.'),
    }),
    dueDate: z.iso.datetime().transform((value) => new Date(value)),
    issuedAt: z.iso.datetime().transform((value) => new Date(value)),
    paidAt: z.union([z.iso.datetime().transform((value) => new Date(value)), z.null()]),
...
export const OrganizationSchema = z.object({
  ...
  deletedAt: z.union([z.iso.datetime().transform((value) => new Date(value)), z.null()]),
  createdAt: z.iso.datetime().transform((value) => new Date(value)),
  updatedAt: z.iso.datetime().transform((value) => new Date(value)),
})
export type Organization = z.infer<typeof OrganizationSchema>
export const OTPSchema = z.object({
  otpId: z.string().uuid().describe('Unique identifier for otp'),
  userId: z.union([z.string().uuid().describe('Unique identifier for user'), z.null()]),
  ...
  resendTime: z.number(),
  dailyLimitAttempts: z.number(),
  expiresIn: z.iso.datetime().transform((value) => new Date(value)),
  createdAt: z.iso.datetime().transform((value) => new Date(value)),
  updatedAt: z.iso.datetime().transform((value) => new Date(value)),
})
...
export const PlanSchema = z.object({
  ...
  trialDays: z.number(),
  features: z
    .array(z.object({ description: z.string(), code: z.literal('ORGANIZATION_COUNT'), props: z.object({ maxOrganizations: z.number().default(1) }) }))
    .default([]),
...
export const SubscriptionSchema = z.union([
  z.object({
    ...
    payer: z.object({
      ...
      phone: z.object({
        iso: z.string().describe('The ISO 3166-1 country code.'),
        ddi: z.string().describe('The international dialing code for the country, prefixed by the plus sign (+).'),
        number: z.string(),
      }),
      document: z.object({
        number: z.string(),
        type: z.enum(['INDIVIDUAL', 'COMPANY']).describe('Represents document types for individuals or companies'),
      }),
      address: z.object({
        state: z.string().describe('Two-letter state code following the ISO 3166-2 standard for country subdivisions.'),
        city: z.string().describe('City name.'),
        zipCode: z.string().describe('ZIP or postal code, containing digits only.'),
        neighborhood: z.string().describe('Neighborhood or district name.'),
        street: z.string().describe('Street name.'),
        number: z.string().describe('Street number.'),
        complement: z.union([z.string(), z.null()]).describe('Additional address details (nullish).'),
      }),
    }),
    deadline: z.iso.datetime().transform((value) => new Date(value)),
    canceledAt: z.union([z.iso.datetime().transform((value) => new Date(value)), z.null()]),
...
export const UserSchema = z.object({
  ...
  workspaceId: z.union([z.string().uuid().describe('Unique identifier for workspaceId'), z.null()]),
  organizationIds: z.array(z.string().uuid().describe('Unique identifier for organization')),
  organizations: z
    .array(
      z.object({
  ...
  social: z.union([
    z
      .object({ googleId: z.union([z.string(), z.null()]), facebookId: z.union([z.string(), z.null()]) })
...
export const WorkspaceSchema = z.object({
  workspaceId: z.string().uuid().describe('Unique identifier for workspace'),
  name: z.string(),
  integrations: z.union([z.object({ recurrenceCustomerId: z.string() }), z.null()]),
  status: z.enum(['ACTIVE', 'INACTIVE']).default('ACTIVE'),
  createdAt: z.iso.datetime().transform((value) => new Date(value)),
  updatedAt: z.iso.datetime().transform((value) => new Date(value)),
})
...
export const PasswordLessSchema = z.object({
  email: z.string().email(),
  otpVerification: z.intersection(
    z.object({ otpId: z.string().uuid().describe('Unique identifier for otp') }),
    z.object({ code: z.string().min(4).max(4) }),
  ),
})
...
export const ListInvoicesSchemaOutput = z.object({
  values: z.array(
    z.union([
      z.object({
        invoiceId: z.string().uuid().describe('Unique identifier for invoice'),
  ...
  meta: z
    .object({ total: z.number().default(0), offset: z.number().default(0), limit: z.number().default(0) })
    .default({ total: 0, offset: 0, limit: 0 }),
})
...
export const GetInvoiceSchemaOutput = z.union([
  z.object({
    invoiceId: z.string().uuid().describe('Unique identifier for invoice'),
    workspaceId: z.string().uuid().describe('Unique identifier for workspace'),
    subscriptionId: z.string().uuid().describe('Unique identifier for subscription'),
...
export const GetPermissionsSchemaOutput = z.array(
  z.object({
    key: z.enum([
      'user:create',
      'user:read',
    ...
    subject: z.enum(['user', 'workspace', 'organization', 'role', 'invoice', 'subscription']),
    action: z.string().describe('Depends on the subject. Common values include: read, write, update, delete.'),
    title: z.string().describe('Human-readable name of the permission.'),
    description: z.string().describe('Detailed explanation of what the permission allows within the system.'),
  }),
)
...
export const ListPlansSchemaOutput = z.object({
  values: z.array(
    z.object({
      ...
      features: z
        .array(
          z.object({ description: z.string(), code: z.literal('ORGANIZATION_COUNT'), props: z.object({ maxOrganizations: z.number().default(1) }) }),
        )
        .default([]),
      highlight: z.boolean().default(false),
      status: z.enum(['ACTIVE', 'INACTIVE']).default('ACTIVE'),
...
export const GetPlanSchemaOutput = z.object({
  planId: z.string().uuid().describe('Unique identifier for plan'),
  externalId: z.string(),
  name: z.string(),
  description: z.string(),
...
export const GetSubscriptionSchemaOutput = z.union([
  z.object({
    subscriptionId: z.string().uuid().describe('Unique identifier for subscription'),
    workspaceId: z.string().uuid().describe('Unique identifier for workspace'),
    planId: z.string().uuid().describe('Unique identifier for plan'),
...
export const CancelSubscriptionSchemaOutput = z.union([
  z.object({
    subscriptionId: z.string().uuid().describe('Unique identifier for subscription'),
    workspaceId: z.string().uuid().describe('Unique identifier for workspace'),
    planId: z.string().uuid().describe('Unique identifier for plan'),
...
export const CreateSubscriptionSchemaOutput = z.union([
  z.object({
    subscriptionId: z.string().uuid().describe('Unique identifier for subscription'),
    workspaceId: z.string().uuid().describe('Unique identifier for workspace'),
    planId: z.string().uuid().describe('Unique identifier for plan'),
...
export const ChangeSubscriptionPlanSchemaOutput = z.union([
  z.object({
    subscriptionId: z.string().uuid().describe('Unique identifier for subscription'),
    workspaceId: z.string().uuid().describe('Unique identifier for workspace'),
    planId: z.string().uuid().describe('Unique identifier for plan'),
...
export const ChangeSubscriptionPaymentMethodSchemaOutput = z.union([
  z.object({
    subscriptionId: z.string().uuid().describe('Unique identifier for subscription'),
    workspaceId: z.string().uuid().describe('Unique identifier for workspace'),
    planId: z.string().uuid().describe('Unique identifier for plan'),
...
export type ChangeSubscriptionPaymentMethodInput = WithFields<
  z.infer<typeof ChangeSubscriptionPaymentMethodSchema>,
  ChangeSubscriptionPaymentMethodOutput
>
...
export const getInvoice = ({ fields, ...input }: GetInvoiceInput): Promise<GetInvoiceOutput> => {
  const { workspaceId, invoiceId, ...query } = input
...
export const getSubscription = ({ fields, ...input }: GetSubscriptionInput): Promise<GetSubscriptionOutput> => {
  const { workspaceId, subscriptionId, ...query } = input
...
export const cancelSubscription = ({ fields, ...input }: CancelSubscriptionInput): Promise<CancelSubscriptionOutput> => {
  ...
  return request
    .delete(`/v1/workspaces/${workspaceId}/subscriptions/${subscriptionId}`, {
      params: {
        fields: formatFields(fields),
        ...query,
      },
...
export const createSubscription = ({ fields, ...input }: CreateSubscriptionInput): Promise<CreateSubscriptionOutput> => {
  ...
  return request
    .post(`/v1/workspaces/${workspaceId}/subscriptions`, body, {
      params: {
        fields: formatFields(fields),
      },
    })
...
export const changeSubscriptionPlan = ({ fields, ...input }: ChangeSubscriptionPlanInput): Promise<ChangeSubscriptionPlanOutput> => {
  ...
  return request
    .post(`/v1/workspaces/${workspaceId}/subscriptions/${subscriptionId}/plan`, body, {
      params: {
        fields: formatFields(fields),
      },
    })
...
export const changeSubscriptionPaymentMethod = ({
  fields,
  ...input
}: ChangeSubscriptionPaymentMethodInput): Promise<ChangeSubscriptionPaymentMethodOutput> => {
  const { workspaceId, subscriptionId, ...body } = input

  return request
    .post(`/v1/workspaces/${workspaceId}/subscriptions/${subscriptionId}/payment-method`, body, {
      params: {
        fields: formatFields(fields),
      },
    })
