...
export const OrganizationSchema = z.object({ "organizationId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })
export type Organization = z.infer<typeof OrganizationSchema>
export const OTPSchema = z.object({ "otpId": z.string().uuid(), "userId": z.string().uuid().nullable(), "channel": z.enum(["EMAIL","SMS","WHATSAPP"]), "context": z.enum(["PASSWORD_LESS","FORGOT_PASSWORD","UPDATE_EMAIL","UPDATE_PHONE"]), "recipient": z.string().min(1), "code": z.string().min(1), "attempts": z.number().default(0), "maxAttempts": z.number().default(0), "resendTime": z.number(), "dailyLimitAttempts": z.number(), "expiresIn": z.void().superRefine((x, ctx) => {
    const schemas = [z.string(), z.void()];
  ...
  }), "createdAt": z.void(), "updatedAt": z.void() })
export type OTP = z.infer<typeof OTPSchema>
export const PlanSchema = z.object({ "planId": z.string().uuid(), "externalId": z.string().min(1), "name": z.string().min(1), "description": z.string().min(1), "amount": z.number().gt(0), "interval": z.enum(["DAY","WEEK","MONTH","YEAR"]), "intervalCount": z.number().default(1), "trialDays": z.number(), "features": z.array(z.object({ "description": z.string().min(1), "code": z.literal("ORGANIZATION_COUNT"), "props": z.object({ "maxOrganizations": z.number().gte(1) }) })).default([]), "highlight": z.boolean().default(false), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })
export type Plan = z.infer<typeof PlanSchema>
export const RoleSchema = z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })
export type Role = z.infer<typeof RoleSchema>
export const SubscriptionSchema = z.object({ "subscriptionId": z.string().uuid(), "workspaceId": z.string().uuid(), "planId": z.string().uuid(), "paymentMethod": z.literal("DEBIT_CARD"), "deadline": z.void(), "billingDueDate": z.void(), "canceledAt": z.void().nullable(), "payer": z.object({ "name": z.string().min(1), "email": z.string().email().min(1), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }), "document": z.object({ "number": z.string().min(1), "type": z.enum(["INDIVIDUAL","COMPANY"]) }), "address": z.object({ "id": z.string().min(1), "state": z.string().min(1), "city": z.string().min(1), "zipCode": z.string().min(1), "neighborhood": z.string().min(1), "street": z.string().min(1), "number": z.string().min(1), "complement": z.string().nullable() }) }), "status": z.enum(["TRIAL","ACTIVE","OVERDUE","CANCELED"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void(), "debitCard": z.object({ "number": z.string().min(1), "holderName": z.string().min(1), "expirationDate": z.string().min(5).max(5), "cvv": z.string().min(3).max(4) }) })
export type Subscription = z.infer<typeof SubscriptionSchema>
export const UserSchema = z.object({ "userId": z.string().uuid(), "workspaceId": z.string().uuid().nullable().nullish(), "roleIds": z.array(z.string().uuid()), "roles": z.array(z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })).default([]), "permissions": z.array(z.string()).min(1), "name": z.string().min(1), "email": z.string().email().min(1), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }).nullable(), "avatar": z.string().nullable(), "social": z.object({ "googleId": z.string().nullable(), "facebookId": z.string().nullable() }).nullable().default({"googleId":null,"facebookId":null}), "password": z.string().min(8), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
export type User = z.infer<typeof UserSchema>
export const WorkspaceSchema = z.object({ "workspaceId": z.string().uuid(), "name": z.string().min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
...
export const PasswordLessSchema = z.object({ "email": z.string().email().min(1), "otpVerification": z.object({ "otpId": z.string().uuid(), "code": z.string().min(4).max(4) }) })
...
export const ForgotPasswordSchema = z.object({ "email": z.string().email().min(1), "password": z.string().min(8), "otpVerification": z.object({ "otpId": z.string().uuid(), "code": z.string().min(4).max(4) }) })
...
export const ListOrganizationsSchema = z.object({ "filter": z.string().nullish(), "workspaceId": z.string().uuid(), "name": z.string().min(1).nullish(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "offset": z.number().int().default(0), "limit": z.number().int().default(10) })
export const ListOrganizationsSchemaOutput = z.object({ "values": z.array(z.object({ "organizationId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })), "meta": z.object({ "total": z.number().int(), "offset": z.number().int(), "limit": z.number().int() }) })
...
export const CreateOrganizationSchema = z.object({ "name": z.string().min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "workspaceId": z.string().uuid() })
export const CreateOrganizationSchemaOutput = z.object({ "organizationId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })
...
export const GetOrganizationSchemaOutput = z.object({ "organizationId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })
...
export const UpdateOrganizationSchema = z.object({ "name": z.string().min(1).nullish(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "workspaceId": z.string().uuid(), "organizationId": z.string().uuid() })
export const UpdateOrganizationSchemaOutput = z.object({ "organizationId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })
...
export const ValidateOTPSchema = z.object({ "context": z.enum(["PASSWORD_LESS","FORGOT_PASSWORD","UPDATE_EMAIL","UPDATE_PHONE"]), "recipient": z.string().min(1), "code": z.string().min(1), "otpId": z.string().uuid() })
...
export const SendPasswordLessOTPSchemaOutput = z.object({ "otpId": z.string().uuid() })
...
export const SendForgotPasswordOTPSchemaOutput = z.object({ "otpId": z.string().uuid() })
...
export const SendUpdateEmailOTPSchemaOutput = z.object({ "otpId": z.string().uuid() })
...
export const SendUpdatePhoneOTPSchema = z.object({ "channel": z.enum(["SMS","WHATSAPP"]), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }) })
export const SendUpdatePhoneOTPSchemaOutput = z.object({ "otpId": z.string().uuid() })
...
export const ListPlansSchemaOutput = z.object({ "values": z.array(z.object({ "planId": z.string().uuid(), "externalId": z.string().min(1), "name": z.string().min(1), "description": z.string().min(1), "amount": z.number().gt(0), "interval": z.enum(["DAY","WEEK","MONTH","YEAR"]), "intervalCount": z.number().default(1), "trialDays": z.number(), "features": z.array(z.object({ "description": z.string().min(1), "code": z.literal("ORGANIZATION_COUNT"), "props": z.object({ "maxOrganizations": z.number().gte(1) }) })).default([]), "highlight": z.boolean().default(false), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })), "meta": z.object({ "total": z.number().int(), "offset": z.number().int(), "limit": z.number().int() }) })
...
export const GetProfileSchemaOutput = z.object({ "userId": z.string().uuid(), "workspaceId": z.string().uuid().nullable().nullish(), "roleIds": z.array(z.string().uuid()), "roles": z.array(z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })).default([]), "permissions": z.array(z.string()).min(1), "name": z.string().min(1), "email": z.string().email().min(1), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }).nullable(), "avatar": z.string().nullable(), "social": z.object({ "googleId": z.string().nullable(), "facebookId": z.string().nullable() }).nullable().default({"googleId":null,"facebookId":null}), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
...
export const UpdateProfileSchemaOutput = z.object({ "userId": z.string().uuid(), "workspaceId": z.string().uuid().nullable().nullish(), "roleIds": z.array(z.string().uuid()), "roles": z.array(z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })).default([]), "permissions": z.array(z.string()).min(1), "name": z.string().min(1), "email": z.string().email().min(1), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }).nullable(), "avatar": z.string().nullable(), "social": z.object({ "googleId": z.string().nullable(), "facebookId": z.string().nullable() }).nullable().default({"googleId":null,"facebookId":null}), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
...
export const UpdateProfileEmailSchema = z.object({ "email": z.string().email().min(1), "otpVerification": z.object({ "otpId": z.string().uuid(), "code": z.string().min(4).max(4) }) })
export const UpdateProfileEmailSchemaOutput = z.object({ "userId": z.string().uuid(), "workspaceId": z.string().uuid().nullable().nullish(), "roleIds": z.array(z.string().uuid()), "roles": z.array(z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })).default([]), "permissions": z.array(z.string()).min(1), "name": z.string().min(1), "email": z.string().email().min(1), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }).nullable(), "avatar": z.string().nullable(), "social": z.object({ "googleId": z.string().nullable(), "facebookId": z.string().nullable() }).nullable().default({"googleId":null,"facebookId":null}), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
...
export const UpdateProfilePhoneSchema = z.object({ "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }), "otpVerification": z.object({ "otpId": z.string().uuid(), "code": z.string().min(4).max(4) }) })
export const UpdateProfilePhoneSchemaOutput = z.object({ "userId": z.string().uuid(), "workspaceId": z.string().uuid().nullable().nullish(), "roleIds": z.array(z.string().uuid()), "roles": z.array(z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })).default([]), "permissions": z.array(z.string()).min(1), "name": z.string().min(1), "email": z.string().email().min(1), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }).nullable(), "avatar": z.string().nullable(), "social": z.object({ "googleId": z.string().nullable(), "facebookId": z.string().nullable() }).nullable().default({"googleId":null,"facebookId":null}), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
...
export const ListRolesSchema = z.object({ "filter": z.string().nullish(), "workspaceId": z.string().uuid(), "name": z.string().min(1).nullish(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "offset": z.number().int().default(0), "limit": z.number().int().default(10) })
export const ListRolesSchemaOutput = z.object({ "values": z.array(z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })), "meta": z.object({ "total": z.number().int(), "offset": z.number().int(), "limit": z.number().int() }) })
...
export const CreateRoleSchema = z.object({ "name": z.string().min(1), "tags": z.array(z.string()).nullable(), "permissions": z.array(z.string()).min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "workspaceId": z.string().uuid() })
export const CreateRoleSchemaOutput = z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })
...
export const GetRoleSchemaOutput = z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })
...
export const UpdateRoleSchema = z.object({ "name": z.string().min(1).nullish(), "tags": z.array(z.string()).nullable().nullish(), "permissions": z.array(z.string()).min(1).nullish(), "workspaceId": z.string().uuid(), "roleId": z.string().uuid() })
export const UpdateRoleSchemaOutput = z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })
...
export const ListUsersSchema = z.object({ "filter": z.string().nullish(), "workspaceId": z.string().uuid(), "name": z.string().min(1).nullish(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "offset": z.number().int().default(0), "limit": z.number().int().default(10) })
export const ListUsersSchemaOutput = z.object({ "values": z.array(z.object({ "userId": z.string().uuid(), "workspaceId": z.string().uuid().nullable().nullish(), "roleIds": z.array(z.string().uuid()), "roles": z.array(z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })).default([]), "permissions": z.array(z.string()).min(1), "name": z.string().min(1), "email": z.string().email().min(1), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }).nullable(), "avatar": z.string().nullable(), "social": z.object({ "googleId": z.string().nullable(), "facebookId": z.string().nullable() }).nullable().default({"googleId":null,"facebookId":null}), "password": z.string().min(8), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })), "meta": z.object({ "total": z.number().int(), "offset": z.number().int(), "limit": z.number().int() }) })
...
export const CreateUserSchema = z.object({ "roleIds": z.array(z.string().uuid()), "permissions": z.array(z.string()).min(1), "name": z.string().min(1), "email": z.string().email().min(1), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }).nullable(), "avatar": z.string().nullable(), "password": z.string().min(8), "workspaceId": z.string().uuid() })
export const CreateUserSchemaOutput = z.object({ "userId": z.string().uuid(), "workspaceId": z.string().uuid().nullable().nullish(), "roleIds": z.array(z.string().uuid()), "roles": z.array(z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })).default([]), "permissions": z.array(z.string()).min(1), "name": z.string().min(1), "email": z.string().email().min(1), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }).nullable(), "avatar": z.string().nullable(), "social": z.object({ "googleId": z.string().nullable(), "facebookId": z.string().nullable() }).nullable().default({"googleId":null,"facebookId":null}), "password": z.string().min(8), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
...
export const UpdateUserSchema = z.object({ "name": z.string().min(1).nullish(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "userId": z.string().uuid(), "workspaceId": z.string().uuid() })
export const UpdateUserSchemaOutput = z.object({ "userId": z.string().uuid(), "workspaceId": z.string().uuid().nullable().nullish(), "roleIds": z.array(z.string().uuid()), "roles": z.array(z.object({ "roleId": z.string().uuid(), "workspaceId": z.string().uuid(), "name": z.string().min(1), "permissions": z.array(z.string()).min(1), "tags": z.array(z.string()).nullable(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "deletedAt": z.void().nullable(), "createdAt": z.void(), "updatedAt": z.void() })).default([]), "permissions": z.array(z.string()).min(1), "name": z.string().min(1), "email": z.string().email().min(1), "phone": z.object({ "iso": z.string().min(1), "ddi": z.string().min(1), "number": z.string().min(1) }).nullable(), "avatar": z.string().nullable(), "social": z.object({ "googleId": z.string().nullable(), "facebookId": z.string().nullable() }).nullable().default({"googleId":null,"facebookId":null}), "password": z.string().min(8), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
...
export const GetWorkspaceSchemaOutput = z.object({ "workspaceId": z.string().uuid(), "name": z.string().min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
...
export const UpdateWorkspaceSchema = z.object({ "name": z.string().min(1).nullish(), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "workspaceId": z.string().uuid() })
export const UpdateWorkspaceSchemaOutput = z.object({ "workspaceId": z.string().uuid(), "name": z.string().min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
...
export const CreateWorkspaceSchemaOutput = z.object({ "workspaceId": z.string().uuid(), "name": z.string().min(1), "status": z.enum(["ACTIVE","INACTIVE"]).default("ACTIVE"), "createdAt": z.void(), "updatedAt": z.void() })
