...
export type RoutePathResponses<T extends 200 | 201 | 204 | 401 | 403 | 404 | 409> = T extends 200 | 201
  ? {
      schema: ZodSchema
    }
  : {
...
export type RouteResponses<T extends HttpStatusResponses> = T extends 204 ? RoutePathResponses<T> : RoutePathResponses<T> | RoutePathResponses<T>[]
