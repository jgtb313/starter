...
// 				input: {
// 					organizationIds: [
// 						organizationMocks[0].organizationId,
// 					],
// 				},
// 				length: 2,
// 				total: 2,
...
// 				input: {
// 					permissionIds: [
// 						roleMocks[0].state.permissions[0].permissionId,
// 					],
// 				},
// 				length: 3,
// 				total: 3,
...
// 					roleMocks.find((role) => role.state.name === 'Contributor')!.state
// 						.roleId,
// 					roleMocks.find((role) => role.state.name === 'Developer')!.state
// 						.roleId,
// 					roleMocks.find((role) => role.state.name === 'Editor')!.state.roleId,
// 					roleMocks.find((role) => role.state.name === 'HR')!.state.roleId,
// 					roleMocks.find((role) => role.state.name === 'Moderator')!.state
// 						.roleId,
// 					roleMocks.find((role) => role.state.name === 'Operator')!.state
// 						.roleId,
...
// 					expect(result.values.map((role) => role.state.roleId)).toEqual(
// 						expectedIds,
// 					)
// 				}
// 			},
...
// 				}),
// 			).rejects.toThrow(new NotFoundException('Role invalid-id not found'))
// 		})
...
// 				organizationMocks[0].organizationId,
// 				organizationMocks[1].organizationId,
// 				organizationMocks[2].organizationId,
// 			]
// 			const permissionIds = [
// 				permissionMocks[0].state.permissionId,
// 				permissionMocks[1].state.permissionId,
// 				permissionMocks[2].state.permissionId,
// 			]
...
// 			expect(
// 				organizationServiceMock.validateOrganizationIds,
// 			).toHaveBeenCalledWith(organizationIds)
// 			expect(permissionServiceMock.validatePermissionIds).toHaveBeenCalledWith(
// 				permissionIds,
// 			)
...
// 			await expect(
// 				service.validateRoleIdsByOrganizationId(organizationId, [
// 					role.state.roleId,
// 				]),
// 			).resolves.toBeUndefined()
// 		})
