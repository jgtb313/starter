...
export const roleMocks: RoleDomain[] = [
  makeRole({
    ...
    organizations: [organizationMocks[0].state],
    permissions: [permissionMocks[0].state, permissionMocks[1].state, permissionMocks[2].state],
  }),
  makeRole({
    name: 'Editor',
  ...
  makeRole({
    ...
    status: RoleStatusEnum.ACTIVE,
    tags: ['read-only'],
    organizations: [organizationMocks[1].state],
    permissions: [permissionMocks[0].state, permissionMocks[1].state, permissionMocks[2].state],
  }),
  makeRole({
    name: 'Analyst',
    ...
    tags: ['data', 'reports'],
    organizations: [organizationMocks[1].state],
    permissions: [permissionMocks[1].state, permissionMocks[2].state],
  }),
  makeRole({
    name: 'Contributor',
    status: RoleStatusEnum.ACTIVE,
    tags: ['content', 'submit'],
    organizations: [organizationMocks[2].state],
    permissions: [permissionMocks[1].state, permissionMocks[2].state],
  }),
  makeRole({
    name: 'Moderator',
  ...
  makeRole({
    ...
    status: RoleStatusEnum.INACTIVE,
    tags: ['ops'],
    organizations: [organizationMocks[3].state],
    permissions: [permissionMocks[1].state, permissionMocks[2].state],
  }),
  makeRole({
    name: 'HR',
    ...
    organizations: [organizationMocks[4].state],
    permissions: [permissionMocks[1].state, permissionMocks[2].state],
  }),
  makeRole({
    name: 'Developer',
