import type { IEmails } from '@starter/emails'
...
export type NotificationTemplatePropsType<T extends NotificationChannel> =
	keyof NotificationTemplateProps[T]
...
export type NotificationInput<
	T extends NotificationChannel,
	K extends keyof NotificationTemplateProps[T],
> = {
	template: K
	recipient: string
...
export type INotificationStrategy<T extends NotificationChannel> = {
	send: <K extends keyof NotificationTemplateProps[T]>(
		input: NotificationInput<T, K>,
	) => void
}
