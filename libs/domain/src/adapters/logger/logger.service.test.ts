...
describe('LoggerService', () => {
  ...
  describe('info', () => {
    it('should call info with correct parameters', () => {
      ...
      expect(mockerLogger.info).toHaveBeenCalledWith('Test message', 'TestEvent')
    })
  })
  ...
  describe('warn', () => {
    it('should call warn with correct parameters', () => {
      ...
      expect(mockerLogger.warn).toHaveBeenCalledWith('Warning message', 'WarningEvent')
    })
  })
  ...
  describe('error', () => {
    it('should call error with correct parameters', () => {
      ...
      expect(mockerLogger.error).toHaveBeenCalledWith('Error message', 'ErrorEvent')
    })
  })
})
