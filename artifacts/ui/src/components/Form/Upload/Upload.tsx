  ...
  return (
    <Dropzone {...props} {...inputProps} openRef={inputRef} classNames={{ root: styles.root() }} onDrop={handleOnDrop} onBlur={handleBlur}>
      <Group style={{ pointerEvents: 'none' }} justify="center" gap="xl" mih={140}>
        <Dropzone.Accept>
          <Icon name="IconUpload" width={52} height={52} strokeWidth={1.5} />
        </Dropzone.Accept>

        <Dropzone.Reject>
          <Icon name="IconX" width={52} height={52} strokeWidth={1.5} />
        </Dropzone.Reject>

        <Dropzone.Idle>
          <Icon name="IconPhoto" width={52} height={52} strokeWidth={1.5} />
        </Dropzone.Idle>
