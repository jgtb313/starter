...
const Icons: Record<SocialIconProps['name'], typeof Google> = {
  GOOGLE: Google,
  FACEBOOK: Facebook,
}

export const SocialIcon = ({ name, width = 40, height = 40, ...props }: SocialIconProps) => {
  const Icon = Icons[name]

  return <Icon name={name} width={width} height={height} {...props} />
}
