...
import { OTP, Role, Store, User } from '@starter/schema'
...
const connect = async (uri: string) => {
  try {
    ...
    Collections.store = await createCollectionMongoDB<CollectionsTypes['store']>('stores')
