...
function getForgotPasswordUrl() {
	const res = {
		method: 'POST',
		url: `http://localhost:4000/v1/auth/forgot-password` as const,
	}
	return res
}
...
export async function forgotPassword(
	data?: ForgotPasswordMutationRequest,
	params?: ForgotPasswordQueryParams,
	headers?: ForgotPasswordHeaderParams,
	config: Partial<RequestConfig<ForgotPasswordMutationRequest>> & {
		client?: typeof fetch
	} = {},
) {
	...
	>({
		method: 'POST',
		url: getForgotPasswordUrl().url.toString(),
		params,
		data: requestData,
		...requestConfig,
		headers: {
